#!/bin/bash
#SBATCH --job-name=MONET_with_offset            # Job name
#SBATCH --output=logs/MONET_with_offset.out   # Standard output log
#SBATCH --error=logs/MONET_with_offset.err    # Standard error log
...
python run_MONET_with_offset.py
