#!/bin/bash
#SBATCH --job-name=MONET_no_offset            # Job name
#SBATCH --output=logs/MONET_no_offset.out   # Standard output log
#SBATCH --error=logs/MONET_no_offset.err    # Standard error log
