...
if __name__ == "__main__":
    ...
    # Save them to CSV
    embeddings.to_csv("output_MSNE_k_20_nw_100_emb_100_win_15_wl_20_embeddings.csv")
    clusters.to_csv("output_MSNE_k_20_nw_100_emb_100_win_15_wl_20_clusters.csv")
