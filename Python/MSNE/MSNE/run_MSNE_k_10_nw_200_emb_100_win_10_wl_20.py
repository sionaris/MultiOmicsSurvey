...
if __name__ == "__main__":
    ...
    # Save them to CSV
    embeddings.to_csv("output_MSNE_k_10_nw_200_emb_100_win_10_wl_20_embeddings.csv")
    clusters.to_csv("output_MSNE_k_10_nw_200_emb_100_win_10_wl_20_clusters.csv")
