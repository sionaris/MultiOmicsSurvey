...
if __name__ == "__main__":
    ...
    # Save them to CSV
    embeddings.to_csv("output_MSNE_k_30_nw_200_emb_200_win_15_wl_40_embeddings.csv")
    clusters.to_csv("output_MSNE_k_30_nw_200_emb_200_win_15_wl_40_clusters.csv")
