...
if __name__ == "__main__":
    ...
    # Save them to CSV
    embeddings.to_csv("output_MSNE_k_40_nw_200_emb_200_win_15_wl_20_embeddings.csv")
    clusters.to_csv("output_MSNE_k_40_nw_200_emb_200_win_15_wl_20_clusters.csv")
