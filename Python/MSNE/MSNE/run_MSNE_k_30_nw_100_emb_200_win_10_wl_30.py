...
if __name__ == "__main__":
    ...
    # Save them to CSV
    embeddings.to_csv("output_MSNE_k_30_nw_100_emb_200_win_10_wl_30_embeddings.csv")
    clusters.to_csv("output_MSNE_k_30_nw_100_emb_200_win_10_wl_30_clusters.csv")
