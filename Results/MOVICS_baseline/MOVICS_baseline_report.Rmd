...
## Clinical variables
With respect to <u>clinical variables</u> statistically significant associations were found between the consensus subtypes and <b>vital status, history of neoadjuvant treatment, histological type, PR status, ER status, HER2 status, and ER and PR cell level percentages</b>. Results can be found in the [summary file](`r paste0(params$home,"/Results/MOVICS_baseline/Summary_of_clinical_variables.txt")`).
...
DGEA is performed in order to compare the expression of the three identified consensus subtypes using the __limma__ package.
...
<ol>
  ...
  <ul>
    <li>CS1 has 77.5% IDC samples, while CS2 has 64.8%. CS1 has 11.5% ILC, while CS2 has 23.6%.</li>
    <li><b>63.5% of CS1 samples are ER+</b>, while <b>79.3% of CS2 samples are ER+</b>.</li>
    <li><b>54.5% of CS1 samples are PR+</b>, while <b>70.1% of CS2 samples are PR+</b>.</li>
  ...
  <li>CS1 and CS2 labels in transNEO are associated with clinical variables of interest. With respect to <b>pCR</b>:</li>
</ol>
...
data_resp <- data.frame(
  ...
  CS1 = c("31 ( 39.2%)", "48 ( 60.8%)"),
  CS2 = c("10 ( 13.5%)", "64 ( 86.5%)")

)

# Print the table using knitr::kable
knitr::kable(data_resp, caption = "Response rates across transNEO CS subtypes")
```
