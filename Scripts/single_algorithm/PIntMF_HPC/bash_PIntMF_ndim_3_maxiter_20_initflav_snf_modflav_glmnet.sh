...
#SBATCH --nodes=1
#SBATCH --job-name=PIntMF_ndim_3_maxiter_20_initflav_snf_modflav_glmnet
#SBATCH --output=logs/PIntMF_ndim_3_maxiter_20_initflav_snf_modflav_glmnet.out
...
# Run the R script
Rscript PIntMF_ndim_3_maxiter_20_initflav_snf_modflav_glmnet.R
