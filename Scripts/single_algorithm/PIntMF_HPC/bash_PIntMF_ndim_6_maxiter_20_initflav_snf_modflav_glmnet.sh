...
#SBATCH --nodes=1
#SBATCH --job-name=PIntMF_ndim_6_maxiter_20_initflav_snf_modflav_glmnet
#SBATCH --output=logs/PIntMF_ndim_6_maxiter_20_initflav_snf_modflav_glmnet.out
#SBATCH --error=logs/PIntMF_ndim_6_maxiter_20_initflav_snf_modflav_glmnet.err
...
# Run the R script
Rscript PIntMF_ndim_6_maxiter_20_initflav_snf_modflav_glmnet.R
