...
clin_comp = compClinvar_single_algorithm(algorithm_name = algorithm,
                                         ...
                                         res.path = paste0(home, "/Results/single_algorithm/CIMLR/"))
...
dgea.marker.up <- runMarker_single_algorithm(algorithm_name = algorithm,
                                             ...
                                             dat.path      = paste0(home, "/Results/single_algorithm/CIMLR"), # path of DEA files
                                             res.path      = paste0(home, "/Results/single_algorithm/CIMLR"), # path to save marker files
...
clust$Cluster = paste0("CIMLR", clust$Cluster)
openxlsx::write.xlsx(clust, paste0(home, "/Results/single_algorithm/CIMLR/", 
...
if (!dir.exists(paste0(home, "/Results/single_algorithm/CIMLR/Supplement"))) {
  dir.create(paste0(home, "/Results/single_algorithm/CIMLR/Supplement"))
}
...
openxlsx::write.xlsx(output, 
                     paste0(home, 
                            "/Results/single_algorithm/CIMLR/Supplement/Chisq_tests.xlsx"),
                     overwrite = TRUE)
...
ARI_to_MOVICS_CIMLR = calculate_ari_index(cluster_df1 = MOVICS_CIMLR %>%
                                        ...
                                        sample_col = "Sample.ID",
                                        clust_col = "Cluster",
                                        suffixes = c("_MOVICS_CIMLR", "_CIMLR"))
...
rmarkdown::render(paste0(getwd(), "/Results/single_algorithm/CIMLR/CIMLR_report.Rmd"), 
                  params = params, 
