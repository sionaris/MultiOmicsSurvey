...
#SBATCH --nodes=1
#SBATCH --job-name=KLIC_hlcust_input_down_KLIC1
#SBATCH --output=logs/KLIC_hlcust_input_down_KLIC1.out
#SBATCH --error=logs/KLIC_hlcust_input_down_KLIC1.err
...
# Run script
Rscript KLIC_hclust_input_down_KLIC1.R