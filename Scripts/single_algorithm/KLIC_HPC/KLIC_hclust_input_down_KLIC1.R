...
input = readRDS("hclust_input_down_KLIC1.rds")
...
# Exports
saveRDS(export, "hclust_output_down_KLIC1.rds")
writeLines(capture.output(sessionInfo()), "sessionInfo_hclust_input_down_KLIC1.txt")
