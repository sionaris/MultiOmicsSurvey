...
#SBATCH --nodes=1
#SBATCH --job-name=KLIC_hlcust_input_up_KLIC2
#SBATCH --output=logs/KLIC_hlcust_input_up_KLIC2.out
#SBATCH --error=logs/KLIC_hlcust_input_up_KLIC2.err
...
# Run script
Rscript KLIC_hclust_input_up_KLIC2.R