...
input = readRDS("hclust_input_up_KLIC2.rds")
...
# Exports
saveRDS(export, "hclust_output_up_KLIC2.rds")
writeLines(capture.output(sessionInfo()), "sessionInfo_hclust_input_up_KLIC2.txt")
