...
#SBATCH --nodes=1
#SBATCH --job-name=iCB_sdev_0.005_beta_0.8
#SBATCH --output=logs/iCB_sdev_0.005_beta_0.8_%j.out
#SBATCH --error=logs/iCB_sdev_0.005_beta_0.8_%j.err
...
# Run R script
Rscript iClusterBayes_HPC_script_sdev_0.005_beta_0.8.R
