...
#SBATCH --nodes=1
#SBATCH --job-name=iCB_sdev_0.005_beta_2.5
#SBATCH --output=logs/iCB_sdev_0.005_beta_2.5_%j.out
#SBATCH --error=logs/iCB_sdev_0.005_beta_2.5_%j.err
...
# Run R script
Rscript iClusterBayes_HPC_script_sdev_0.005_beta_2.5.R
