...
#SBATCH --nodes=1
#SBATCH --job-name=iCB_sdev_0.025_beta_0.3
#SBATCH --output=logs/iCB_sdev_0.025_beta_0.3_%j.out
#SBATCH --error=logs/iCB_sdev_0.025_beta_0.3_%j.err
...
# Run R script
Rscript iClusterBayes_HPC_script_sdev_0.025_beta_0.3.R
