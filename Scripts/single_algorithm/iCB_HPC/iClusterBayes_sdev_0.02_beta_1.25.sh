...
#SBATCH --nodes=1
#SBATCH --job-name=iCB_sdev_0.02_beta_1.25
#SBATCH --output=logs/iCB_sdev_0.02_beta_1.25_%j.out
#SBATCH --error=logs/iCB_sdev_0.02_beta_1.25_%j.err
...
# Run R script
Rscript iClusterBayes_HPC_script_sdev_0.02_beta_1.25.R
