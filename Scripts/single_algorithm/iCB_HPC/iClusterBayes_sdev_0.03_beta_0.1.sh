...
#SBATCH --nodes=1
#SBATCH --job-name=iCB_sdev_0.03_beta_0.1
#SBATCH --output=logs/iCB_sdev_0.03_beta_0.1_%j.out
#SBATCH --error=logs/iCB_sdev_0.03_beta_0.1_%j.err
...
# Run R script
Rscript iClusterBayes_HPC_script_sdev_0.03_beta_0.1.R
