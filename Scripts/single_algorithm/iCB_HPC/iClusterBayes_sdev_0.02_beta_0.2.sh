...
#SBATCH --nodes=1
#SBATCH --job-name=iCB_sdev_0.02_beta_0.2
#SBATCH --output=logs/iCB_sdev_0.02_beta_0.2_%j.out
#SBATCH --error=logs/iCB_sdev_0.02_beta_0.2_%j.err
...
# Run R script
Rscript iClusterBayes_HPC_script_sdev_0.02_beta_0.2.R
