...
#SBATCH --nodes=1
#SBATCH --job-name=iCB_sdev_0.01_beta_0.3
#SBATCH --output=logs/iCB_sdev_0.01_beta_0.3_%j.out
#SBATCH --error=logs/iCB_sdev_0.01_beta_0.3_%j.err
...
# Run R script
Rscript first_prelim_run_iClusterBayes_HPC_script_sdev_0.5_beta_1.R
