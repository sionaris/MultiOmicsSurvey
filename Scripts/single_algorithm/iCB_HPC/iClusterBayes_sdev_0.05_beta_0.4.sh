...
#SBATCH --nodes=1
#SBATCH --job-name=iCB_sdev_0.05_beta_0.4
#SBATCH --output=logs/iCB_sdev_0.05_beta_0.4_%j.out
#SBATCH --error=logs/iCB_sdev_0.05_beta_0.4_%j.err
...
# Run R script
Rscript iClusterBayes_HPC_script_sdev_0.05_beta_0.4.R
