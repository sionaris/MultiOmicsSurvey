...
#SBATCH --nodes=1
#SBATCH --job-name=Methylation_mixKernel
#SBATCH --output=logs/Methylation_mixKernel.out
#SBATCH --error=logs/Methylation_mixKernel.err
...
# Run the R script
Rscript mixKernel_Methylation.R
