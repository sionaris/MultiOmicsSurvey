...
# ------------------------------------------------------------------------------
ent.save(outfile="MOFA_output_factors25_ard_iter20000_R2_-1.hdf5")

print("MOFA training complete. Results saved to \"MOFA_output_factors25_iter20000_R2_-1.hdf5\"")
