...
#SBATCH --nodes=1
#SBATCH --job-name=nmf_nruns_150_maxiter_200_lr_1e-04
#SBATCH --output=logs/nmf_nruns_150_maxiter_200_lr_1e-04_%j.out
#SBATCH --error=logs/nmf_nruns_150_maxiter_200_lr_1e-04_%j.err
...
# 3) Run R script
Rscript nmf_nruns_150_maxiter_200_lr_1e-04.R
