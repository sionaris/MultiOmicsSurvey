...
#SBATCH --nodes=1
#SBATCH --job-name=nmf_nruns_300_maxiter_500_lr_5e-04
#SBATCH --output=logs/nmf_nruns_300_maxiter_500_lr_5e-04_%j.out
#SBATCH --error=logs/nmf_nruns_300_maxiter_500_lr_5e-04_%j.err
...
# 3) Run R script
Rscript nmf_nruns_300_maxiter_500_lr_5e-04.R
