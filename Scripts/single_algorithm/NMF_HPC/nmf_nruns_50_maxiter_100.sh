...
#SBATCH --nodes=1
#SBATCH --job-name=nmf_nruns_50_maxiter_100
#SBATCH --output=logs/nmf_nruns_50_maxiter_100_%j.out
#SBATCH --error=logs/nmf_nruns_50_maxiter_100_%j.err
...
# Run R script
Rscript nmf_nruns_50_maxiter_100.R
