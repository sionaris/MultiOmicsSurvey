...
#SBATCH --nodes=1
#SBATCH --job-name=nmf_nruns_50_maxiter_2000_lr_0.005
#SBATCH --output=logs/nmf_nruns_50_maxiter_2000_lr_0.005_%j.out
#SBATCH --error=logs/nmf_nruns_50_maxiter_2000_lr_0.005_%j.err
...
# 3) Run R script
Rscript nmf_nruns_50_maxiter_2000_lr_0.005.R
