...
#SBATCH --nodes=1
#SBATCH --job-name=nmf_nruns_100_maxiter_200
#SBATCH --output=logs/nmf_nruns_100_maxiter_200_%j.out
#SBATCH --error=logs/nmf_nruns_100_maxiter_200_%j.err
...
# Run R script
Rscript nmf_nruns_100_maxiter_200.R
