...
#SBATCH --nodes=1
#SBATCH --job-name=nmf_nruns_200_maxiter_1000_lr_0.001
#SBATCH --output=logs/nmf_nruns_200_maxiter_1000_lr_0.001_%j.out
#SBATCH --error=logs/nmf_nruns_200_maxiter_1000_lr_0.001_%j.err
...
# 3) Run R script
Rscript nmf_nruns_200_maxiter_1000_lr_0.001.R
