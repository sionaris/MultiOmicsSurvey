...
#SBATCH --nodes=1
#SBATCH --job-name=nmf_nruns_75_maxiter_50
#SBATCH --output=logs/nmf_nruns_75_maxiter_50_%j.out
#SBATCH --error=logs/nmf_nruns_75_maxiter_50_%j.err
...
# Run R script
Rscript nmf_nruns_75_maxiter_50.R
