...
#SBATCH --nodes=1
#SBATCH --job-name=nmf_nruns_200_maxiter_100_lr_0.005
#SBATCH --output=logs/nmf_nruns_200_maxiter_100_lr_0.005_%j.out
#SBATCH --error=logs/nmf_nruns_200_maxiter_100_lr_0.005_%j.err
...
# 3) Run R script
Rscript nmf_nruns_200_maxiter_100_lr_0.005.R
