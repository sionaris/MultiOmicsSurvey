...
#SBATCH --output=logs/abSNF_robust_sample.out
#SBATCH --error=logs/abSNF_robust_sample.err
#SBATCH --exclusive

set -euo pipefail

METHOD="${METHOD:-ab-SNF}"
SCRIPT="${SCRIPT:-Jobs/ab-SNF/ab-SNF_sample_experiments.R}"
