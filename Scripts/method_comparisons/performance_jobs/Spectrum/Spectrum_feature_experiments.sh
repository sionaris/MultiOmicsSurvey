...
#SBATCH --job-name=Spectrum_feat
#SBATCH --output=logs/Spectrum_robust_feat.out
#SBATCH --error=logs/Spectrum_robust_feat.err
#SBATCH --exclusive

set -euo pipefail

METHOD="${METHOD:-Spectrum}"
PROPERTY="${PROPERTY:-robust_feat}"
POINT="${POINT:-feat_subsets}"
SCRIPT="${SCRIPT:-Jobs/Spectrum/Spectrum_feature_experiments.R}"
...
# Ensure SLURM_CPUS_PER_TASK is consistent
