...
#SBATCH --job-name=Spectrum_samp
#SBATCH --output=logs/Spectrum_robust_sample.out
#SBATCH --error=logs/Spectrum_robust_sample.err
#SBATCH --exclusive

set -euo pipefail

METHOD="${METHOD:-Spectrum}"
PROPERTY="${PROPERTY:-robust_sample}"
POINT="${POINT:-sample_subsets}"
SCRIPT="${SCRIPT:-Jobs/Spectrum/Spectrum_sample_experiments.R}"
