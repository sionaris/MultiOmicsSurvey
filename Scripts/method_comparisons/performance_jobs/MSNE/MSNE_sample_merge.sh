...
#SBATCH --job-name=MSNE_samp_merge
#SBATCH --output=logs/MSNE_samp_merge_%j.out
#SBATCH --error=logs/MSNE_samp_merge_%j.err
...
srun --hint=nomultithread --cpu-bind=cores \
  Rscript "${SLURM_SUBMIT_DIR}/Jobs/MSNE/MSNE_sample_experiments.R" merge
