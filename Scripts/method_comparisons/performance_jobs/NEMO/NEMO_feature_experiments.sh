...
#SBATCH --job-name=NEMO_feat
#SBATCH --output=logs/NEMO_robust_feat.out
#SBATCH --error=logs/NEMO_robust_feat.err
#SBATCH --exclusive
...
SCRIPT="${SCRIPT:-Jobs/NEMO/NEMO_feature_experiments.R}"
