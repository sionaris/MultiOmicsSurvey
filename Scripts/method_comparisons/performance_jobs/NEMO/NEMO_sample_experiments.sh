...
#SBATCH --job-name=NEMO_samp
#SBATCH --output=logs/NEMO_robust_sample.out
#SBATCH --error=logs/NEMO_robust_sample.err
#SBATCH --exclusive

set -euo pipefail

METHOD="${METHOD:-NEMO}"
SCRIPT="${SCRIPT:-Jobs/NEMO/NEMO_sample_experiments.R}"
