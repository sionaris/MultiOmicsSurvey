...
# IMPORTANT: MUST be provided so we write into the same array_<RUN_ID> as the lowmem job
: "${RUN_ID:?Set RUN_ID to the jobid of the lowmem feature array job (see sbatch commands below)}"
