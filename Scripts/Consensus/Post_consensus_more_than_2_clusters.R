...
ggsave(file.path(home, "Results/Consensus_more_than_2/Post/ARI_vs_consensus_bars.png"),
       p, dpi = 700, width = 9, height = 6)
ggsave(file.path(home, "Results/Consensus_more_than_2/Post/ARI_vs_consensus_bars.pdf"),
       p, dpi = 700, width = 9, height = 6)
...
newdir = paste0(home, "/Results/Consensus_more_than_2/Post")
